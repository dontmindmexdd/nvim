...
nmap_leader('fg', '<Cmd>FzfLua grep<CR>',                    'Grep live')
nmap_leader('fG', '<Cmd>FzfLua grep_cword<CR>',       'Grep current word')
nmap_leader('fh', '<Cmd>FzfLua helptags<CR>',                         'Help tags')
nmap_leader('fF', '<Cmd>FzfLua lgrep_curbuf<CR>',        'Grep buffer')
nmap_leader('fl', '<Cmd>FzfLua grep_curbuf<CR>',    'Lines (buf)')
...
vim.keymap.set('n', 'grr', '<Cmd>Pick lsp scope="references"<CR>', { desc = 'References (LSP)' })
